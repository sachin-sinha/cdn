      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          {name: "TimeSinceLoad", type: "TimeSinceLoad", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"Time since page load","Name":"newWeb","Description":"desc"}, Variable: "TimeSinceLoadVariable"},
          ]
        },
        Templates
      );
