            ...
            function sendPostRequestViaSendBeacon(request, callback, fallbackToGet) {
                ...
                try {
                    ...
                    function isNumeric(str) {
                        ...
                        return (
                            !isNaN(str) && !isNaN(parseFloat(str)) // use type coercion to parse the entirety of the string (`parseFloat` alone does not do this)...
                    ...
                    function getHashCode(s) {
                        ...
                        while (i < c) { hash = ((hash << 5) - hash) + s.charCodeAt(i++); }
                    ...
                    DataToSend['refer'] = DataToSend?.urlref
                    const ts = Date.now().toString()
                    DataToSend['ts'] = ts
                    DataToSend['token'] = getHashCode(DataToSend?.urlref + ts)
