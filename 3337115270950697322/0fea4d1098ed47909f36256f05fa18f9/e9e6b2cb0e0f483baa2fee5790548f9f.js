...
(function () {
    ...
    return function (parameters, TagManager) {
      this.get = function () {
        ...
        return TagManager.url.getQueryParameter(name, parameters.window.location.search);
          ...
          Templates["CustomJsFunctionVariable365a7addf4b64d5cb0eacfbc82bc442f"] = (function () {
            return function (parameters, TagManager) {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "8c0f70db-a409-4eaa-b779-efe4acdd2aec",
  "type": "Matomo",
  "name": "Quote Form",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "id": "365a7add-f4b6-4d5c-b0ea-cfbc82bc442f",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable365a7addf4b64d5cb0eacfbc82bc442f"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "14cce47b-80d7-4cc3-87a2-8b10728981b1"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "2e6239da-661f-4e51-8f6a-2e7d65fe098d",
  "type": "Matomo",
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "f967502a-ef8a-489c-b902-ea97340c20e3",
  "type": "Matomo",
  "name": "IP",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "IP",
          "dataLayerName": "ip",
          "id": "0fb6dbd0-7fa6-4d70-9677-78adc6da8e2c",
          "parameters": {
            "selectedVariable": "Data layer",
            "Variable": "DataLayerVariable",
            "name": "DataLayer",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "51c731ec-6dc3-4d60-91b0-bdcb4e11e625"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "e3abecc1-6c14-4bfb-a982-e02bacb31e95",
  "type": "Matomo",
  "name": "Scroll25",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "897cdd88-9838-40b5-835c-33718884dc61"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "d7360444-cb90-43f0-93d2-0b4281d87255",
  "type": "Matomo",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "79565ddc-38ce-47e6-bc79-78fdf3b47263"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "conditions": [
    {
      ...
      "expected": "https://used-motors-for-sale.com/"
    }
  ],
  ...
  "Description": "Triggered every time a new page is visited. (Only for the websites which are not single page / which reload the page while navigating. Such as websites built with: WordPress, HTML, PHP etc)."
            ...
            {
  "id": "14cce47b-80d7-4cc3-87a2-8b10728981b1",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "Name": "Quote Form Submit"
            ...
            {
  "id": "51c731ec-6dc3-4d60-91b0-bdcb4e11e625",
  "type": "CustomEvent",
  "name": "CustomEvent",
  ...
  "Name": "IP event"
            ...
            {
  "id": "897cdd88-9838-40b5-835c-33718884dc61",
  "type": "ScrollReach",
  "name": "ScrollReach",
  ...
  "Name": "Scroll25"
            ...
            {
  "id": "79565ddc-38ce-47e6-bc79-78fdf3b47263",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
