...
(function () {
    ...
    return function (parameters, TagManager) {
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariable15f6f782dce84bf2b3533410d8feddef"] = (function () {
            return function (parameters, TagManager) {
                this.get = function() {var fd={};var fe=document.querySelector('.bangdbcollector');fd.sel_make=fe.elements['sel_make'].value;fd.sel_mode=fe.elements['sel_mode'].value;fd.sel_year=fe.elements['sel_year'].value;fd.sel_part=fe.elements['sel_part'].value;fd.sel_size=fe.elements['sel_size'].value;fd.txt_name=fe.elements['txt_name'].value;fd.email=fe.elements['txt_email'].value;fd.txt_phon=fe.elements['txt_phon'].value;return JSON.stringify(fd);}
            };
        })()
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "aa4e40a8-321a-44fd-b002-e3856667c185"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "7afae868-101b-4e4b-b9a1-60b6e065ecbf",
  "type": "Matomo",
  "name": "ScreenWidth",
  "parameters": {
    "matomoConfig": {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "452c4ba9-ab23-47db-9e57-3cf5938e8500",
  "type": "Matomo",
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "311e940f-265a-4097-8587-0be3e6b01da9",
  "type": "Matomo",
  "name": "PageViewURL",
  "parameters": {
    "matomoConfig": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "PageViewURL",
    "Description": "Returns URL of the page."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "717b4f6c-48ea-4396-a497-2e1c063c2b91"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "c57db7a9-d9cc-4534-b06f-2cadf9737353",
  "type": "Matomo",
  "name": "IP",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Name": "IP",
          "dataLayerName": "ip",
          "id": "b016ff30-fd84-4838-b56f-e6fea63d4e33",
          "parameters": {
            "selectedVariable": "Data layer",
            "Variable": "DataLayerVariable",
            "name": "DataLayer",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "a2cd7cc7-204e-4e12-8503-cabae211250e"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "37f6f713-1cbb-4826-bcfe-10ee0a6da323",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function() {var fd={};var fe=document.querySelector('.bangdbcollector');fd.sel_make=fe.elements['sel_make'].value;fd.sel_mode=fe.elements['sel_mode'].value;fd.sel_year=fe.elements['sel_year'].value;fd.sel_part=fe.elements['sel_part'].value;fd.sel_size=fe.elements['sel_size'].value;fd.txt_name=fe.elements['txt_name'].value;fd.txt_phon=fe.elements['txt_phon'].value;sessionStorage.setItem('bangDBForm',JSON.stringify(fd));return 'formSubmit';}",
          "id": "15f6f782-dce8-4bf2-b353-3410d8feddef",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable15f6f782dce84bf2b3533410d8feddef"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "19d5eab8-7642-4e03-aaf1-e676943017cb",
  "type": "Matomo",
  "name": "Scroll25",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "e199f471-2f57-4d86-9221-d52112f3d6a4"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "2988c89e-5321-4249-9555-4bc11ffa0257",
  "type": "Matomo",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "8062b83a-ce92-46a8-8b78-f2f21eb6a373"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "conditions": [
    {
      ...
      "expected": "https://www.autoparts-pro.com/"
    }
  ],
  ...
  "Description": "History Change"
            ...
            {
  "id": "de76625b-a560-42c2-b9b5-beeb37bcfe3a",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Description": "Pageview (All)"
            ...
            {
  "id": "a2cd7cc7-204e-4e12-8503-cabae211250e",
  "type": "CustomEvent",
  "name": "CustomEvent",
  ...
  "Description": "Sends data, when call button is clicked on the website."
            ...
            {
  "id": "e199f471-2f57-4d86-9221-d52112f3d6a4",
  "type": "ScrollReach",
  "name": "ScrollReach",
  ...
  "Name": "Scroll25"
            ...
            {
  "id": "8062b83a-ce92-46a8-8b78-f2f21eb6a373",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
