      ...
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariablec34e68e709854e0e95e78d1ad7eaa023"] = (function () {
            return function (parameters, TagManager) {
                this.get = function() {var fd = {};var fe = document.querySelector('form#f1');
console.log('triggered', fe);fd.sel_year=fe.elements['sel_year'].value;fd.sel_make=fe.elements['sel_make'].value;fd.sel_mode=fe.elements['sel_mode'].value;fd.sel_size=fe.elements['sel_size'].value;fd.sel_part=fe.elements['sel_part'].value;fd.txt_name=fe.elements['txt_name'].value;fd.txt_phon=fe.elements['txt_phon'].value;return JSON.stringify(fd);}
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "89fdd427-be14-41d7-8e94-b2896937b701",
  "type": "Matomo",
  "name": "PageClick",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "dff10369-de77-448b-b181-2dfe4753c1aa"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "9cba0afa-84e4-424e-99f4-680e24f65ee0",
  "type": "Matomo",
  "name": "Quote Form",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "30dfe778-3be0-442b-8d12-f588785465ab"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Description": "Custom event for IP Address"
            ...
            {
  "id": "30dfe778-3be0-442b-8d12-f588785465ab",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "parameters": {
    ...
    "dataLayerName": "ip"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function() {var fd = {};var fe = document.querySelector('form#f1');
