...
(function () {
      ...
      this.get = function () {
        ...
        return TagManager.url.getQueryParameter(name, parameters.window.location.search);
          ...
          Templates["CustomJsFunctionVariable00b64f6bc5dd4b52b543bb04de072b9f"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['email']){if(formElement.elements['lastname']){if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};data.last_name=formElement.elements['lastname'].value;};data.email=formElement.elements['email'].value;};console.log('registration triggered for', data);return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "bd1edc73-c273-49b7-87cc-a5dcae1bdcaf",
  "type": "Matomo",
  "name": "Latitude",
  "parameters": {
    "matomoConfig": {
      ...
      "parameters": {
        ...
        "trackingEndpoint": "stream/FORM_TEST/Data"
      },
      ...
      "joinedVariable": [
        {
          ...
          "type": "DataLayer",
          "Name": "Latitude",
          "Description": "Reads latitude value from the Data-Layer.",
          "dataLayerName": "latitude",
          "id": "dc30b068-0185-4e7f-8ac8-7c312ed78028",
          "parameters": {
            "selectedVariable": "Data layer",
            "Variable": "DataLayerVariable",
            "name": "DataLayer",
    ...
    "Name": "Latitude",
    "Description": "This tag lets you track latitude of the visitors into your tag manager."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "09e16631-2b6c-42c2-898d-bb97f28b1d31",
  "type": "Matomo",
  "name": "Longitude",
  "parameters": {
    "matomoConfig": {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "ee02f967-bef6-4053-a595-55edaf352fa7",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['email']){if(formElement.elements['lastname']){if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};data.last_name=formElement.elements['lastname'].value;};data.email=formElement.elements['email'].value;};return JSON.stringify(data)}",
          "id": "00b64f6b-c5dd-4b52-b543-bb04de072b9f",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable00b64f6bc5dd4b52b543bb04de072b9f"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "856b494d-9e7c-455f-9933-36f46d3f541b"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Description": "Triggered every time a new page is visited. (Only for the websites which are not single page / which reload the page while navigating. Such as websites built with: WordPress, HTML, PHP etc)."
            ...
            {
  "id": "856b494d-9e7c-455f-9933-36f46d3f541b",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "parameters": {
    ...
    "parameterName": "utm_medium"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['email']){if(formElement.elements['lastname']){if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};data.last_name=formElement.elements['lastname'].value;};data.email=formElement.elements['email'].value;};console.log('registration triggered for', data);return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable00b64f6bc5dd4b52b543bb04de072b9f" },
            {
