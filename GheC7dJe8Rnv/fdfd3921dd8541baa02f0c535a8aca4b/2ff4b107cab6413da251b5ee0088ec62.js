...
(function () {
      ...
      this.get = function () {
        ...
        return TagManager.url.getQueryParameter(name, parameters.window.location.search);
          ...
          Templates["CustomJsFunctionVariable00b64f6bc5dd4b52b543bb04de072b9f"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['email']){if(formElement.elements['lastname']){if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};data.last_name=formElement.elements['lastname'].value;};data.email=formElement.elements['email'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  "parameters": {
    ...
    "parameterName": "utm_medium"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['email']){if(formElement.elements['lastname']){if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};data.last_name=formElement.elements['lastname'].value;};data.email=formElement.elements['email'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable00b64f6bc5dd4b52b543bb04de072b9f" },
            {
