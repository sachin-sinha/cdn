...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    this.setUp = function (triggerEvent) {
      ...
      TagManager.dom.onLoad(setIntersectionObserver(triggerEvent));
          ...
          Templates["CustomJsFunctionVariable2350dafe3ba74e5b85e713490023b386"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sa2')){data.producd_id=document.querySelector('sa2').innerHTML};if(document.querySelector('sa1.span.price-new')){const matches = document.querySelector('sa1.span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "61229e7f-6231-450b-8d82-52314b204ec0",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "2350dafe-3ba7-4e5b-85e7-13490023b386",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable2350dafe3ba74e5b85e713490023b386"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "8b17272c-d3f7-4b3d-9261-cb01430d860b"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "8b17272c-d3f7-4b3d-9261-cb01430d860b",
  ...
  "Name": "product_view Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sa2')){data.producd_id=document.querySelector('sa2').innerHTML};if(document.querySelector('sa1.span.price-new')){const matches = document.querySelector('sa1.span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable2350dafe3ba74e5b85e713490023b386" },
            {
