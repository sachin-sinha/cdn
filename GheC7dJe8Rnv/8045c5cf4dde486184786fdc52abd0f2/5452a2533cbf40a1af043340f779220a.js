...
(function () {
    ...
    function clickCallback(event, triggerEvent, clickButton) {
      ...
      triggerEvent({
        ...
        "mtm.clickButton": clickButton,
          ...
          Templates["CustomJsFunctionVariable5b1906a6607d4fa58704ea427fe3dddf"] = (function () {
            return function (parameters, TagManager) {
          ...
          Templates["CustomJsFunctionVariable1b68eb8978fd4e538d9473c9c76ce044"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable699f13846b1c46e899955947ecb67c60"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "7857bffe-fa85-4395-9bc4-274b0b92875a",
  "type": "Matomo",
  "name": "add_cart Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "id": "5b1906a6-607d-4fa5-8704-ea427fe3dddf",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable5b1906a6607d4fa58704ea427fe3dddf"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "083a6f77-8063-4b5a-9d90-cd797b43005f"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "08b12cda-1a69-4b00-bf5c-d8a52c23fe57",
  "type": "Matomo",
  "name": "add_cart Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "1b68eb89-78fd-4e53-8d94-73c9c76ce044",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable1b68eb8978fd4e538d9473c9c76ce044"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "2f9b8f2d-2b39-4679-b1ad-b4a9739742dc"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "8e3b1e0e-8ac7-46ca-aadb-43a92d0c9039",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "699f1384-6b1c-46e8-9995-5947ecb67c60",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable699f13846b1c46e899955947ecb67c60"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "1aae687f-1d5f-4603-8470-dd1e4853e549"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Name": "login Trigger"
            ...
            {
  "id": "083a6f77-8063-4b5a-9d90-cd797b43005f",
  ...
  "Name": "add_cart Trigger"
            ...
            {
  "id": "2f9b8f2d-2b39-4679-b1ad-b4a9739742dc",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Name": "add_cart Trigger"
            ...
            {
  "id": "1aae687f-1d5f-4603-8470-dd1e4853e549",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Name": "add_wishlist Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable5b1906a6607d4fa58704ea427fe3dddf" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable1b68eb8978fd4e538d9473c9c76ce044" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable699f13846b1c46e899955947ecb67c60" },
            {
