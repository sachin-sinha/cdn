...
(function () {
    ...
    function clickCallback(event, triggerEvent, clickButton) {
      ...
      triggerEvent({
        ...
        "mtm.clickButton": clickButton,
          ...
          Templates["CustomJsFunctionVariable942c0518cb7b4207a5db47682ca8e709"] = (function () {
            return function (parameters, TagManager) {
          ...
          Templates["CustomJsFunctionVariable35fd045eb2744140906149b044ab0f97"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable0d8f0f51b3a84d91a79b6f28e3855fa6"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable7cb57290ca1e473aaea908e7fdbeb8ec"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('prdct')){data.producd_id=document.querySelector('prdct').innerHTML};if(document.querySelector('prd3')){const matches = document.querySelector('prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('price')){const matches = document.querySelector('price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable26575fa60c21441096c75e00ad5244d4"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('li#pudct')){data.producd_id=document.querySelector('li#pudct').innerHTML};if(document.querySelector('li#prd3')){const matches = document.querySelector('li#prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('li#price')){const matches = document.querySelector('li#price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "8e1269c2-6659-4a03-a9d1-1a834c8b59d7",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "id": "57fd1613-371b-4339-a077-041857055c66",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable57fd1613371b4339a077041857055c66"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "b5ff9e79-6ffb-4005-ace3-63ae2019fc74"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "a3f256af-5a1f-41df-9ffd-97dff9e915a7",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "942c0518-cb7b-4207-a5db-47682ca8e709",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable942c0518cb7b4207a5db47682ca8e709"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "56ace7f8-ff49-4862-ab5e-10fac7009dd8"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "dc334f21-6ef0-4623-8449-74603c478952",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "35fd045e-b274-4140-9061-49b044ab0f97",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable35fd045eb2744140906149b044ab0f97"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "7dbd973d-2784-44dd-a519-1c869d8061f3"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "1c4f9964-38bf-4bb0-ba71-7eed76f8ca13",
  "type": "Matomo",
  "name": "product_view Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "0d8f0f51-b3a8-4d91-a79b-6f28e3855fa6",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable0d8f0f51b3a84d91a79b6f28e3855fa6"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "338d105b-51ce-409d-a7b7-dc788f8232c7"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "1c57e785-b917-45f5-9c58-12b7094bc348",
  "type": "Matomo",
  "name": "add_cart Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('prdct')){data.producd_id=document.querySelector('prdct').innerHTML};if(document.querySelector('prd3')){const matches = document.querySelector('prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('price')){const matches = document.querySelector('price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "7cb57290-ca1e-473a-aea9-08e7fdbeb8ec",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable7cb57290ca1e473aaea908e7fdbeb8ec"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "41744fa1-f087-4938-b7f0-b490df1c50f1"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "dd917558-976e-4a4f-af48-a821c50ec430",
  "type": "Matomo",
  "name": "add_cart Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('li#pudct')){data.producd_id=document.querySelector('li#pudct').innerHTML};if(document.querySelector('li#prd3')){const matches = document.querySelector('li#prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('li#price')){const matches = document.querySelector('li#price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "26575fa6-0c21-4410-96c7-5e00ad5244d4",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable26575fa60c21441096c75e00ad5244d4"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "ef6d732f-d148-49fc-abc7-ddbdd1ac3032"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "b5ff9e79-6ffb-4005-ace3-63ae2019fc74",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
            ...
            {
  "id": "56ace7f8-ff49-4862-ab5e-10fac7009dd8",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "7dbd973d-2784-44dd-a519-1c869d8061f3",
  ...
  "Name": "product_view Trigger"
            ...
            {
  "id": "338d105b-51ce-409d-a7b7-dc788f8232c7",
  "type": "ElementVisibility",
  "name": "ElementVisibility",
  "Trigger": "ElementVisibilityTrigger",
  "selectedTrigger": "Element Visibility",
  ...
  "Name": "product_view Trigger"
            ...
            {
  "id": "41744fa1-f087-4938-b7f0-b490df1c50f1",
  ...
  "conditions": [
    {
      ...
      "comparison": "equals",
      "expected": "button-cart"
    }
  ],
  "Name": "add_cart Trigger"
},
            {
  "id": "ef6d732f-d148-49fc-abc7-ddbdd1ac3032",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Name": "add_cart Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['email']){data.userid=formElement.elements['email'].value;};if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable57fd1613371b4339a077041857055c66" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-register');if(formElement.elements['firstname']){data.first_name=formElement.elements['firstname'].value;};if(formElement.elements['lastname']){data.last_name=formElement.elements['lastname'].value;};if(formElement.elements['email']){data.email=formElement.elements['email'].value;};if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable942c0518cb7b4207a5db47682ca8e709" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable35fd045eb2744140906149b044ab0f97" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('sandeep-pid')){data.producd_id=document.querySelector('sandeep-pid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable0d8f0f51b3a84d91a79b6f28e3855fa6" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('prdct')){data.producd_id=document.querySelector('prdct').innerHTML};if(document.querySelector('prd3')){const matches = document.querySelector('prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('price')){const matches = document.querySelector('price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable7cb57290ca1e473aaea908e7fdbeb8ec" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('li#pudct')){data.producd_id=document.querySelector('li#pudct').innerHTML};if(document.querySelector('li#prd3')){const matches = document.querySelector('li#prd3').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('li#price')){const matches = document.querySelector('li#price').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable26575fa60c21441096c75e00ad5244d4" },
            {
