...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariable38e7faacaffc434fa4d68b4cb63d9aeb"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "a9546ee2-6fe3-41d3-b9af-783026e4e250",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}",
          "id": "38e7faac-affc-434f-a4d6-8b4cb63d9aeb",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable38e7faacaffc434fa4d68b4cb63d9aeb"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "598bef47-79b4-4a8c-8035-417f33ff042c"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "598bef47-79b4-4a8c-8035-417f33ff042c",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable38e7faacaffc434fa4d68b4cb63d9aeb" },
            {
