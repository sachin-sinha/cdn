...
(function () {
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "6e719bae-8d03-49f6-ba65-e717a1ca700d",
  "type": "Matomo",
  "name": "Location",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "type": "DataLayer",
          "Name": "ip",
          "Description": "This variable collects the IP address stats of a user.",
          "dataLayerName": "ip",
          "id": "ca9789ef-8098-4232-be96-e469c52f4bf8",
          "parameters": {
            "selectedVariable": "Data layer",
            "Variable": "DataLayerVariable",
            "name": "DataLayer",
    ...
    "Name": "Location",
    "Description": "This tag is responsible to bind the IP variable with the location trigger."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "829b72a2-d300-4f54-8eee-f0c52307eb37"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "5698cef7-7141-4222-9815-f90802a2dbfb",
  "type": "Matomo",
  ...
  "parameters": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "BrowserLanguage",
    "Description": "This tag gets us the browser language on first load."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "ef20b60a-1294-49d1-92d5-a428c1377f02"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "c0cd6cd9-cf3d-4c81-916b-8313e38b0fc8",
  "type": "Matomo",
  "name": "Pageview",
  "parameters": {
    "matomoConfig": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "Pageview",
    "Description": "This gets the URL of the page that is being viewed."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "a5824543-fda0-4466-ab92-957941dc56af"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "b58f80d1-c146-4bdd-8376-0cf42150ecff",
  "type": "Matomo",
  "name": "History Change",
  "parameters": {
    "matomoConfig": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "History Change",
    "Description": "This tag returns the Page URL whenever the URL of the page changes."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "dd51687a-507e-4e13-a764-74c1dba90af8"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "464d8e51-5a1a-4178-87bb-664dcd9cd9cc",
  "type": "Matomo",
  "name": "WindowUnload",
  "parameters": {
    "matomoConfig": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "WindowUnload",
    "Description": "This tag returns the Page URL when a user closes the browser window."
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "86ea6215-b2bd-4881-bf47-4b4a4c07cf25"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "b3cc8dca-5254-43c9-b955-c860a5c34d4f",
  "type": "Matomo",
  "name": "scroll_tag",
  "parameters": {
    "matomoConfig": {
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "scroll_tag",
    "Description": "Page scroll more than 25"
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "65c552a9-9802-4b55-ba00-2300f055804a"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "2ff76007-2aa6-4901-9710-a1b32d57652f",
  "type": "Matomo",
  "name": "AECTag",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "0b25e357-a2fb-495b-b0a0-7a759db35a0f"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "conditions": [],
  "Name": "History Change",
  "Description": "This triggers whenever the URL of the page changes."
},
            {
  "id": "86ea6215-b2bd-4881-bf47-4b4a4c07cf25",
  "type": "WindowUnload",
  "name": "WindowUnload",
  ...
  "Description": "Triggered just before the browser window is closed."
            ...
            {
  "id": "65c552a9-9802-4b55-ba00-2300f055804a",
  "type": "ScrollReach",
  "name": "ScrollReach",
  ...
  "Description": "When any linked is clicked"
            ...
            {
  "id": "0b25e357-a2fb-495b-b0a0-7a759db35a0f",
