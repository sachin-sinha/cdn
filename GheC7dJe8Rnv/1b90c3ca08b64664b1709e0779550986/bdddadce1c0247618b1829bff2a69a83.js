...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    this.setUp = function (triggerEvent) {
      ...
      TagManager.dom.onLoad(setIntersectionObserver(triggerEvent));
          ...
          Templates["CustomJsFunctionVariable917bd0fa0ee048e3b4de3d5ba2599cf3"] = (function () {
            return function (parameters, TagManager) {
          ...
          Templates["CustomJsFunctionVariable4d3cbea54f554bbcbb4fbd859081e2f3"] = (function () {
            return function (parameters, TagManager) {
          ...
          Templates["CustomJsFunctionVariable1954ed467ce24fad88942197898477fb"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){const matches = document.querySelector('bdb-tracker-stock').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable744b764f729d4f4380ff40235d2810f2"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('product_id')){data.producd_id=document.querySelector('product_id').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "11adba95-23c9-42f6-a26c-36e2035e634c",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "parameters": {
        ...
        "trackingEndpoint": "stream/44d2255b_Ecommerce/Data"
      },
      ...
      "joinedVariable": [
        {
          ...
          "id": "917bd0fa-0ee0-48e3-b4de-3d5ba2599cf3",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable917bd0fa0ee048e3b4de3d5ba2599cf3"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "5a51dc88-edfb-4c13-b9e9-9295eeb5820a"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "b2e0adf3-971c-4f79-b9ca-985a697ead9f",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "4d3cbea5-4f55-4bbc-bb4f-bd859081e2f3",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable4d3cbea54f554bbcbb4fbd859081e2f3"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "3a88052b-fceb-4a8a-a484-ee41673725bd"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "65d5f816-5f14-4cc7-af62-1b4e84313ad4",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "1954ed46-7ce2-4fad-8894-2197898477fb",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable1954ed467ce24fad88942197898477fb"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "8166c890-457e-4d9b-bfe3-29494189b5d8"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "471f7e47-70be-4c98-afae-64cc4064ef3f",
  "type": "Matomo",
  "name": "product_view Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {};const regex = /[-+]?[0-9]*\\.?[0-9]+/g; if(document.querySelector('product_id')){data.producd_id=document.querySelector('product_id').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}",
          "id": "744b764f-729d-4f43-80ff-40235d2810f2",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable744b764f729d4f4380ff40235d2810f2"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "c4f8a958-e46e-4ba7-a411-e9a0b5079ab4"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "5a51dc88-edfb-4c13-b9e9-9295eeb5820a",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
            ...
            {
  "id": "3a88052b-fceb-4a8a-a484-ee41673725bd",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "8166c890-457e-4d9b-bfe3-29494189b5d8",
  ...
  "Name": "product_view Trigger"
            ...
            {
  "id": "c4f8a958-e46e-4ba7-a411-e9a0b5079ab4",
  "type": "ElementVisibility",
  "name": "ElementVisibility",
  "Trigger": "ElementVisibilityTrigger",
  "selectedTrigger": "Element Visibility",
  ...
  "Name": "product_view Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){const matches = document.querySelector('bdb-tracker-stock').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable1954ed467ce24fad88942197898477fb" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('product_id')){data.producd_id=document.querySelector('product_id').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable744b764f729d4f4380ff40235d2810f2" },
            {
