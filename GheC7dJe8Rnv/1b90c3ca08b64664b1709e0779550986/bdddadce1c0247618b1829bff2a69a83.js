...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    this.setUp = function (triggerEvent) {
      ...
      TagManager.dom.onLoad(setIntersectionObserver(triggerEvent));
          ...
          Templates["CustomJsFunctionVariableef51a63f8dbf49c29aa1fbed5f85c83f"] = (function () {
            return function (parameters, TagManager) {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "9ea8c8c7-26d3-4a18-be4d-1208118be8ac",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "ef51a63f-8dbf-49c2-9aa1-fbed5f85c83f",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableef51a63f8dbf49c29aa1fbed5f85c83f"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "64cbb331-3204-4d65-ac7e-3a5fa4bf9fdd"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "64cbb331-3204-4d65-ac7e-3a5fa4bf9fdd",
  ...
  "Name": "product_view Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('img.img-fluid')){data.producd_id=document.querySelector('img.img-fluid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableef51a63f8dbf49c29aa1fbed5f85c83f" },
            {
