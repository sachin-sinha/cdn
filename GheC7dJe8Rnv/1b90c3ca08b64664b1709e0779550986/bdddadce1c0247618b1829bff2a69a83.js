...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    this.setUp = function (triggerEvent) {
      ...
      TagManager.dom.onLoad(setIntersectionObserver(triggerEvent));
          ...
          Templates["CustomJsFunctionVariable3348e9f522df4e47b94e1f0758fd8f78"] = (function () {
            return function (parameters, TagManager) {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "16625246-8950-4ac5-93eb-bd5e2b5f700a",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "3348e9f5-22df-4e47-b94e-1f0758fd8f78",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable3348e9f522df4e47b94e1f0758fd8f78"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "57e4ccce-b87b-4caf-ab7e-34ac7dbb22b0"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "57e4ccce-b87b-4caf-ab7e-34ac7dbb22b0",
  ...
  "Name": "product_view Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('img.img-fluid')){data.producd_id=document.querySelector('img.img-fluid').innerHTML};if(document.querySelector('span.price-new')){const matches = document.querySelector('span.price-new').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable3348e9f522df4e47b94e1f0758fd8f78" },
            {
