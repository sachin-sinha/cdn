...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariableb77ac1d48bb0421da7cecaf76507796e"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['name']){data.userid=formElement.elements['name'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "f61465a0-58eb-4cfa-a15b-951ffa4bf7b9",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['name']){data.userid=formElement.elements['name'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}",
          "id": "b77ac1d4-8bb0-421d-a7ce-caf76507796e",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableb77ac1d48bb0421da7cecaf76507796e"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "8858cda6-c77b-48c2-86bc-cc83173c01f9"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "8858cda6-c77b-48c2-86bc-cc83173c01f9",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['name']){data.userid=formElement.elements['name'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableb77ac1d48bb0421da7cecaf76507796e" },
            {
