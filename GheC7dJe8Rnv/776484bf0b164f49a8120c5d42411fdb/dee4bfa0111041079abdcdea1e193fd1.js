...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    this.setUp = function (triggerEvent) {
      ...
      TagManager.dom.onLoad(setIntersectionObserver(triggerEvent));
          ...
          Templates["CustomJsFunctionVariable6f63db9c36f943aea31d4d5ef6349e9e"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('prodid')){data.producd_id=document.querySelector('prodid').innerHTML};if(document.querySelector('sellid')){data.seller_id=document.querySelector('sellid').innerHTML};if(document.querySelector('stockid')){const matches = document.querySelector('stockid').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('pricefield')){const matches = document.querySelector('pricefield').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "f1257ed2-71ff-4482-9473-a67a9c38d842",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "id": "6f63db9c-36f9-43ae-a31d-4d5ef6349e9e",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable6f63db9c36f943aea31d4d5ef6349e9e"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "b1e06c4e-2f76-4f76-908f-843827656467"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "b1e06c4e-2f76-4f76-908f-843827656467",
  ...
  "Name": "product_view Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};const regex = /[-+]?[0-9]*\.?[0-9]+/g; if(document.querySelector('prodid')){data.producd_id=document.querySelector('prodid').innerHTML};if(document.querySelector('sellid')){data.seller_id=document.querySelector('sellid').innerHTML};if(document.querySelector('stockid')){const matches = document.querySelector('stockid').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.stock=isNaN(number) ? '' : number};};if(document.querySelector('pricefield')){const matches = document.querySelector('pricefield').innerHTML.match(regex);if(matches && matches.length > 0) {const number = parseFloat(matches[0]); data.price_per_unit=isNaN(number) ? '' : number};};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable6f63db9c36f943aea31d4d5ef6349e9e" },
            {
