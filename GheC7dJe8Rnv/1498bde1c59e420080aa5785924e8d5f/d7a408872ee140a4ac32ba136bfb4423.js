...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariablefd4ae20f54d8423d8ecf21656ae7ef1c"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#formnew');if(formElement.elements['uesrid']){data.userid=formElement.elements['uesrid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "5a0917a2-9148-4971-97b4-96862000f385",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "parameters": {
        ...
        "trackingEndpoint": "stream/bf86a921_Ecommerce/Data"
      },
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#formnew');if(formElement.elements['uesrid']){data.userid=formElement.elements['uesrid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}",
          "id": "fd4ae20f-54d8-423d-8ecf-21656ae7ef1c",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariablefd4ae20f54d8423d8ecf21656ae7ef1c"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "e6ece721-5bcb-4878-a4e1-f905ce34684c"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "e6ece721-5bcb-4878-a4e1-f905ce34684c",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#formnew');if(formElement.elements['uesrid']){data.userid=formElement.elements['uesrid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariablefd4ae20f54d8423d8ecf21656ae7ef1c" },
            {
