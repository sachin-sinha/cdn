...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariableb07e040f6b4849ef9f036bb16f0c9f23"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "d5dd2ee7-2d1d-449f-8513-bbab859b3592",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}",
          "id": "b07e040f-6b48-49ef-9f03-6bb16f0c9f23",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableb07e040f6b4849ef9f036bb16f0c9f23"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "49f1ced8-e2d6-4578-b08e-75a6097f2f0e"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "49f1ced8-e2d6-4578-b08e-75a6097f2f0e",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#formid');if(formElement.elements['userid']){data.userid=formElement.elements['userid'].value;};if(formElement.elements['pwd']){data.password=formElement.elements['pwd'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableb07e040f6b4849ef9f036bb16f0c9f23" },
            {
