      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          {name: "TimeSinceLoad", type: "TimeSinceLoad", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"Time since page load","Name":"name","Description":"description","unit":"Seconds"}, Variable: "TimeSinceLoadVariable"}
          ]
        },
        Templates
      );
