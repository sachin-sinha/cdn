...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "b23d1c33-29f1-4b17-bf3e-e55617638120",
  "type": "Matomo",
  "name": "Element click",
  "parameters": {
    "matomoConfig": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "Element click return class",
    "eventAction": "Element click action return class",
    "eventName": "Element click name",
    "eventValue": {
      "name": "ClickClasses",
      "type": "ClickClasses",
      "lookUpTable": [],
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "799ced37-25a2-41d9-9cf4-ce936b2e97a1"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Type": "BangDB Analytics",
  "id": "8574915d-e789-4e50-b284-e6e9a49f230d",
  "type": "Matomo",
  "parameters": {
    "matomoConfig": {
      "name": "Matomo Configuration",
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "return className on linkClick",
    "eventAction": "return className on linkClick",
    "eventName": "return className on linkClick",
    "eventValue": {
      "name": "ClickClasses",
      "type": "ClickClasses",
      "lookUpTable": [],
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "return className on linkClick",
    "Description": "return className on linkClick"
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "799ced37-25a2-41d9-9cf4-ce936b2e97a1"
  ...
  "name": "9134dd9d2194bc388b19a90c09d1efc1",
  "Type": "BangDB Analytics",
  "id": "644bd120-bef8-4ce9-8424-d728798313ea",
  "type": "Matomo",
  "parameters": {
    "matomoConfig": {
      "name": "Matomo Configuration",
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "return className on linkClickreturn className on linkClick",
    "eventAction": "return className on linkClickreturn className on linkClick",
    "eventName": "return className on linkClickreturn className on linkClick",
    "eventValue": {
      "name": "ClickClasses",
      "type": "ClickClasses",
      "lookUpTable": [],
    ...
    "selectedTag": "BangDB Analytics",
    "Name": "return className oreturn className on linkClickn linkClick",
    "Description": "return className on linkClickreturn className on linkClick"
  },
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "dec5f94b-1b41-4624-89ea-f956c53f6eab"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          {
  "id": "799ced37-25a2-41d9-9cf4-ce936b2e97a1",
  ...
  "Description": "Element click"
          ...
          {
  "id": "dec5f94b-1b41-4624-89ea-f956c53f6eab",
  "type": "AllLinksClick",
  "name": "AllLinksClick",
