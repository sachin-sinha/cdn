      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          triggers: [],
          variables: [
             {name: "TimeSinceLoad", type: "TimeSinceLoad", lookUpTable: [], defaultValue: "", parameters: [object Object], Variable: "TimeSinceLoadVariable"} {name: "DomElement", type: "DomElement", lookUpTable: [], defaultValue: "", parameters: [object Object], Variable: "DomElementVariable"}
          ]
        },
        Templates
      );
