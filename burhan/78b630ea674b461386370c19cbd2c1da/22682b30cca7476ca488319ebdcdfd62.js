      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          {name: "Cookie", type: "Cookie", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"First-Party Cookie","Name":"name","Description":"description","cookieName":"cookie name","urlDecode":true}, Variable: "CookieVariable"},
          ]
        },
        Templates
      );
