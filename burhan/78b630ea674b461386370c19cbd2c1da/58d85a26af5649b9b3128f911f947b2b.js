      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          {name: "DataLayer", type: "DataLayer", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"Data layer","Name":"name","Description":"desc","dataLayerName":"datalayer"}, Variable: "DataLayerVariable"},
          ]
        },
        Templates
      );
