      ...
      window.MatomoTagManager.addContainer(
        {
          ...
          {name: "ReferrerUrl", type: "ReferrerUrl", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"Referrer URL","Name":"name","Description":"description","URL path":"hostname"}, Variable: "ReferrerUrlVariable"},
          {name: "ReferrerUrl", type: "ReferrerUrl", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"Referrer URL","urlPart":"host","Description":"des","Name":"name"}, Variable: "ReferrerUrlVariable"},
          {name: "DomElement", type: "DomElement", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"DOM Element","Name":"name","Description":"desc","selectionMethod":"elementId","cssSelector":"sele","elementId":"select","attributeName":"Name"}, Variable: "DomElementVariable"},
          {name: "Cookie", type: "Cookie", lookUpTable: [], defaultValue: "", parameters: {"selectedVariable":"First-Party Cookie","Name":"name","Description":"desc","cookieName":"cookie","urlDecode":true}, Variable: "CookieVariable"},
          ]
        },
        Templates
      );
