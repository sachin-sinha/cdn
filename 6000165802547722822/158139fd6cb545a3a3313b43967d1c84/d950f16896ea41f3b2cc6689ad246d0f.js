...
(function () {
    ...
    function clickCallback(event, triggerEvent, clickButton) {
      ...
      triggerEvent({
        ...
        "mtm.clickButton": clickButton,
          ...
          Templates["CustomJsFunctionVariableea9ba04ccfa14084befb3d7fd8c9c556"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['input-email']){data.userid=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariable9148bd9bad534a60b8de46675fd70668"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#content');if(formElement.elements['input-firstname']){data.first_name=formElement.elements['input-firstname'].value;};if(formElement.elements['input-lastname']){data.last_name=formElement.elements['input-lastname'].value;};if(formElement.elements['input-email']){data.email=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariablee67f04e490674263b72b4356e1328ae4"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariableba94e8f90216447cb222ee5a261c2b39"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};if(document.querySelector('price-new')){data.price_per_unit=document.querySelector('price-new').innerHTML};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "2fa55b9e-8fb8-4d2e-a511-da1dafc3e27e",
  "type": "Matomo",
  "name": "login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "parameters": {
        ...
        "trackingEndpoint": "stream/ed48b2ad_Ecommerce/Data"
      },
      ...
      "joinedVariable": [
        {
          ...
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['input-email']){data.userid=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}",
          "id": "ea9ba04c-cfa1-4084-befb-3d7fd8c9c556",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableea9ba04ccfa14084befb3d7fd8c9c556"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "5cd4df4e-1b92-497a-b919-c5a5015d19a6"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "db7ccf05-7df6-4038-bea6-530e6a993c9f",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#content');if(formElement.elements['input-firstname']){data.first_name=formElement.elements['input-firstname'].value;};if(formElement.elements['input-lastname']){data.last_name=formElement.elements['input-lastname'].value;};if(formElement.elements['input-email']){data.email=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}",
          "id": "9148bd9b-ad53-4a60-b8de-46675fd70668",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable9148bd9bad534a60b8de46675fd70668"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "c25485f4-3249-426c-afb2-0cb72ef5829a"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "338b1a26-cd69-4214-b51b-994a632ab735",
  "type": "Matomo",
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};return JSON.stringify(data)}",
          "id": "e67f04e4-9067-4263-b72b-4356e1328ae4",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariablee67f04e490674263b72b4356e1328ae4"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "fe7a8eb3-62d7-400f-be67-ca0150b559a2"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "e39966c3-33e8-4d5c-8c6a-5ba4fbc68794",
  "type": "Matomo",
  "name": "add_cart Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};if(document.querySelector('price-new')){data.price_per_unit=document.querySelector('price-new').innerHTML};return JSON.stringify(data)}",
          "id": "ba94e8f9-0216-447c-b222-ee5a261c2b39",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableba94e8f90216447cb222ee5a261c2b39"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "8ac86a03-51ad-4fe4-9064-4c333b879c62"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "5cd4df4e-1b92-497a-b919-c5a5015d19a6",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "login Trigger"
            ...
            {
  "id": "c25485f4-3249-426c-afb2-0cb72ef5829a",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "Name": "registration Trigger"
            ...
            {
  "id": "fe7a8eb3-62d7-400f-be67-ca0150b559a2",
  ...
  "Name": "product_view Trigger"
            ...
            {
  "id": "8ac86a03-51ad-4fe4-9064-4c333b879c62",
  ...
  "Name": "add_cart Trigger"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['input-email']){data.userid=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableea9ba04ccfa14084befb3d7fd8c9c556" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#content');if(formElement.elements['input-firstname']){data.first_name=formElement.elements['input-firstname'].value;};if(formElement.elements['input-lastname']){data.last_name=formElement.elements['input-lastname'].value;};if(formElement.elements['input-email']){data.email=formElement.elements['input-email'].value;};if(formElement.elements['input-password']){data.password=formElement.elements['input-password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable9148bd9bad534a60b8de46675fd70668" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariablee67f04e490674263b72b4356e1328ae4" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; if(document.querySelector('bdb-tracker-product_id')){data.producd_id=document.querySelector('bdb-tracker-product_id').innerHTML};if(document.querySelector('bdb-tracker-stock')){data.stock=document.querySelector('bdb-tracker-stock').innerHTML};if(document.querySelector('price-new')){data.price_per_unit=document.querySelector('price-new').innerHTML};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableba94e8f90216447cb222ee5a261c2b39" },
            {
