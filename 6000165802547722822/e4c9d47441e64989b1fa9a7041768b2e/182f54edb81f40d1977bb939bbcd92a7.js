      ...
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariable6827171878ce407cb0873aabde691db8"] = (function () {
            return function (parameters, TagManager) {
                this.get = function() {var fd = {};var fe=document.querySelector('#download2644"]');fd.email=fe.elements['email'].value;fd.firstname=fe.elements['firstname'].value;fd.lastname=fe.elements['lastname'].value;return JSON.stringify(fd);}
            };
        })()
  ...
  "parameters": {
    ...
    "parameters": {
      ...
      "dataLayerName": "IP"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function() {var fd = {};var fe=document.querySelector('#download2644"]');fd.email=fe.elements['email'].value;fd.firstname=fe.elements['firstname'].value;fd.lastname=fe.elements['lastname'].value;return JSON.stringify(fd);}" }, Variable: "CustomJsFunctionVariable6827171878ce407cb0873aabde691db8" },
            {
