...
(function () {
  ...
  return function (parameters, TagManager) {
    ...
    return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "2204dba6-a08d-4e2f-aa6c-5a6d30757389",
  "type": "Matomo",
  "name": "form Data",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Name": "Form Data",
          "jsFunction": "function() {var fd = {};var fe=document.querySelector('form#formID');fd.name=fe.elements['username'].value;fd.password=fe.elements['password'].value;sessionStorage.setItem('formData', JSON.stringify(fd));return JSON.stringify(fd);}",
          ...
          "parameters": {
            ...
            "parameters": {
              ...
              "parameters": {
                ...
                "type": "CustomJsFunction",
                "Name": "Form Data",
                "jsFunction": "function(event) {event.preventDefault();var fd = {};var fe=document.querySelector('form#formID');fd.name=fe.elements['username'].value;fd.password=fe.elements['password'].value;return JSON.stringify(fd);}",
                "id": "588ab484-0562-4599-b7a2-d6fe70e97e87",
                "parameters": {
                  "selectedVariable": "Custom JavaScript",
                  "name": "CustomJsFunction",
  ...
  "fireTriggerIds": [],
  "blockedTriggerIds": [],
  "id": "3565e4c6-cffd-440e-9412-b69eef39a5db",
  "Tag": "CustomHtmlTag"
},
          ],
          triggers: [
  ...
  "Name": "Form Submit"
            ...
            {
  "id": "893cf9be-1353-4b4f-a86d-53e3003709fd",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
