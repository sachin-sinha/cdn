      ...
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariable9d6ec8556ac544cd96ea1c63678ae2f7"] = (function () {
            return function (parameters, TagManager) {
                this.get = function() {var fd = {};var fe=document.querySelector('form.bdb-tracker-productform');console.log('this is what got triggered', fd);fd.product=fe.elements['product_id'].value;fd.quantity=fe.elements['quantity'].value;return JSON.stringify(fd);}
            };
        })()
    ...
    "eventValue": {
      "joinedVariable": [
        ...
        },
        {
          ...
          "type": "CustomJsFunction",
          "Name": "product form",
          "jsFunction": "function() {var fd = {};var fe=document.querySelector('form.bdb-tracker-productform');console.log('this is what got triggered', fd);fd.product=fe.elements['product_id'].value;fd.quantity=fe.elements['quantity'].value;return JSON.stringify(fd);}",
          "Description": "product form",
          "id": "9d6ec855-6ac5-44cd-96ea-1c63678ae2f7",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            ...
            "parameters": {
              ...
              "type": "CustomJsFunction",
              "Name": "product form",
              "jsFunction": "function() {var fd = {};var fe=document.querySelector('form.sandy-product');console.log('this is what got triggered', fd);fd.product=fe.elements['product_id'].value;fd.quantity=fe.elements['quantity'].value;return JSON.stringify(fd);}",
              "Description": "product form",
              "id": "9d6ec855-6ac5-44cd-96ea-1c63678ae2f7",
              "parameters": {
                "selectedVariable": "Custom JavaScript",
    ...
    "parameters": {
      ...
      "parameters": {
        ...
        "parameters": {
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function() {var fd = {};var fe=document.querySelector('form.bdb-tracker-productform');console.log('this is what got triggered', fd);fd.product=fe.elements['product_id'].value;fd.quantity=fe.elements['quantity'].value;return JSON.stringify(fd);}" }, Variable: "CustomJsFunctionVariable9d6ec8556ac544cd96ea1c63678ae2f7" },
            {
