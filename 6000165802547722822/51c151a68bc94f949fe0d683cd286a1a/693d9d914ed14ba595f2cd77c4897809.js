    ...
    "parameters": {
      ...
      "parameters": {
        ...
        "parameters": {
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function() {const elements = document.querySelectorAll(`[id^='bdb-tracker']`);console.log('new tag got triggered 2');const elementData = {};elements.forEach(element => {console.log(element.id, element);const temp = element.id.replace('bdb-tracker-', '');const arr = temp?.split('-') || [];const id = arr[0] || 'NA';const text = arr[1] || 'NA';elementData[id] = text;});return JSON.stringify(elementData)}" }, Variable: "CustomJsFunctionVariable70a5f886fc744985aaafea10d3a2a4fa" },
            {
