...
(function () {
    ...
    return function (parameters, TagManager) {
      this.get = function () {
        ...
        if (dataLayerName && parameters.container) {
          ...
          Templates["CustomJsFunctionVariable01c51e4e1efd4d9b96fa2f2d1786cd01"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.product_id=formElement.elements['product_id'].value;};data.quantity=formElement.elements['quantity'].value;};return JSON.stringify(data)}
            };
        })()
          
          Templates["CustomJsFunctionVariablef84639de487a447ca9c76ca5e3dee729"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {};if(document.querySelector('li#bdb-tracker-product_id')){data.product=document.querySelector('li#bdb-tracker-product_id').innerHTML};if(document.querySelector('li#bdb-tracker-stock')){data.stock=document.querySelector('li#bdb-tracker-stock').innerHTML}; return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "9317f9df-3d8a-4aac-9a68-4bc9d02b2b78",
  "type": "Matomo",
  "name": "Location",
  "parameters": {
    "matomoConfig": {
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "e24eb80b-6070-4d67-a4b0-16ea95289ec1"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "parameters": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "remove_wishlist",
    "eventAction": "remove_wishlist",
    "eventName": "sync",
    "eventValue": {
      "joinedVariable": [
        {
  ...
  "blockedTriggerIds": []
        ...
        {
  "id": "590332cf-1637-4d6e-b204-64cca1ab0d48",
  "type": "Matomo",
  "name": "newTEMP Tag",
  "parameters": {
    "matomoConfig": {
      ...
      "joinedVariable": [
        {
          ...
          "name": "CustomJsFunction",
          "type": "CustomJsFunction",
          "Name": "newTEMP Variable",
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.product_id=formElement.elements['product_id'].value;};data.quantity=formElement.elements['quantity'].value;};return JSON.stringify(data)}",
          "id": "01c51e4e-1efd-4d9b-96fa-2f2d1786cd01",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable01c51e4e1efd4d9b96fa2f2d1786cd01"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "9b7ae295-135e-4654-a52f-e444ef656638"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
      ...
      "joinedVariable": [
        {
          ...
          "name": "CustomJsFunction",
          "type": "CustomJsFunction",
          "Name": "pageCollect Variable",
          "Description": "Created Via Page Collection template",
          "jsFunction": "function(){const data = {};if(document.querySelector('li#bdb-tracker-product_id')){data.product=document.querySelector('li#bdb-tracker-product_id').innerHTML};if(document.querySelector('li#bdb-tracker-stock')){data.stock=document.querySelector('li#bdb-tracker-stock').innerHTML}; return JSON.stringify(data)}",
          "id": "f84639de-487a-447c-a9c7-6ca5e3dee729",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariablef84639de487a447ca9c76ca5e3dee729"
        }
      ]
    },
    "selectedTag": "BangDB Analytics",
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "9b3b79e4-3f58-4649-85d6-3e51459b9b54",
  ...
  "Description": "Product viewed"
            ...
            {
  "id": "e24eb80b-6070-4d67-a4b0-16ea95289ec1",
  "type": "CustomEvent",
  "name": "CustomEvent",
  ...
  "Name": "Add Cart"
            ...
            {
  "id": "42ee1601-ab73-428f-a884-e61e0c964cb3",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Name": "Add Wishlist"
            ...
            {
  "id": "bfcd31ad-0209-4312-8c63-5e6ea04ea046",
  "type": "AllElementsClick",
  "name": "AllElementsClick",
  "Trigger": "AllElementsClickTrigger",
  "selectedTrigger": "All Elements Click",
  ...
  "Description": "Trigger to control Language"
            ...
            {
  "id": "9b7ae295-135e-4654-a52f-e444ef656638",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "conditions": [
    {
      ...
      "comparison": "equals",
      "expected": "productform"
    }
  ],
  "Name": "newTEMP Trigger"
},
          ],
          variables: [
    ...
    "parameters": {
      ...
      "parameters": {
        ...
        "parameters": {
          ...
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.product_id=formElement.elements['product_id'].value;};data.quantity=formElement.elements['quantity'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable01c51e4e1efd4d9b96fa2f2d1786cd01" },
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {};if(document.querySelector('li#bdb-tracker-product_id')){data.product=document.querySelector('li#bdb-tracker-product_id').innerHTML};if(document.querySelector('li#bdb-tracker-stock')){data.stock=document.querySelector('li#bdb-tracker-stock').innerHTML}; return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariablef84639de487a447ca9c76ca5e3dee729" },
            {
