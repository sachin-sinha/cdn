...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariablecfad6d6c0b0d47d8b64b3c27c92cd370"] = (function () {
            return function (parameters, TagManager) {
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "3d55360e-de39-4df6-8f35-f6d89eb18089",
  "type": "Matomo",
  "name": "Product Form",
  "parameters": {
    "matomoConfig": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "Testing submit",
    "eventAction": "Testing submit",
    "eventName": "sync",
    "eventValue": {
      "joinedVariable": [
        {
          ...
          "jsFunction": "function() {var fd = {};var fe = document.querySelector('form.bdb-tracker-productform');if (fe.elements['product_id']) {fd.product = fe.elements['product_id'].value;};if (fe.elements['quantity']) {fd.quantity = fe.elements['quantity'].value;};if (fe.elements['key']) {fd.product = fe.elements['key'].value;};return JSON.stringify(fd);}",
          "id": "cfad6d6c-0b0d-47d8-b64b-3c27c92cd370",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariablecfad6d6c0b0d47d8b64b3c27c92cd370"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "3a387006-70f1-4573-be7f-ccdd2df4ab95"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "3a387006-70f1-4573-be7f-ccdd2df4ab95",
  "type": "FormSubmit",
  "name": "FormSubmit",
