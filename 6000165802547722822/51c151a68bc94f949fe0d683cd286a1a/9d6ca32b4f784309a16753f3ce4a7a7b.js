...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariable90f8c6d9a40b4086b75456890ca4c661"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector("form#productform");if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.productID=formElement.elements['product_id'].value;};data.QuantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "d47721cb-f99c-4d48-a476-037e98b06a14",
  "type": "Matomo",
  "name": "New template test Tag",
  "parameters": {
    "matomoConfig": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "template test 2",
    "eventAction": "template test 2",
    "eventName": "sync",
    "eventValue": {
      "joinedVariable": [
        {
          ...
          "Name": "New template test Variable",
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector(\"form#productform\");if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.productID=formElement.elements['product_id'].value;};data.QuantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}",
          "id": "90f8c6d9-a40b-4086-b754-56890ca4c661",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariable90f8c6d9a40b4086b75456890ca4c661"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "f349bb46-fcd5-4ab5-ad7f-8c8064d5f6c6"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "f349bb46-fcd5-4ab5-ad7f-8c8064d5f6c6",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "New template test Trigger"
},
          ],
          variables: [
            
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector("form#productform");if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.productID=formElement.elements['product_id'].value;};data.QuantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariable90f8c6d9a40b4086b75456890ca4c661" },
            {
