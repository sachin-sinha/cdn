...
(function () {
    ...
    this.setUp = function (triggerEvent) {
      TagManager.dom.onReady(function () {
        TagManager.dom.addEventListener(
          ...
          Templates["CustomJsFunctionVariableec2e086acbaa43b8b1fa25bd0fc65f73"] = (function () {
            return function (parameters, TagManager) {
                this.get = function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.id=formElement.elements['product_id'].value;};data.quantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}
            };
        })()
  ...
  return function (parameters, TagManager) {
      ...
      window.MatomoTagManager.addContainer(
        ...
        {
  "id": "93cecaf1-b580-4cd7-ad91-49b2a5a9ca36",
  "type": "Matomo",
  "name": "tempname Tag",
  "parameters": {
    "matomoConfig": {
    ...
    "documentTitle": "",
    "customUrl": "",
    "eventCategory": "categoryTemplate",
      ...
      "joinedVariable": [
        {
          ...
          "Name": "tempname Variable",
          "Description": "Created Via Form Submit template",
          "jsFunction": "function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.id=formElement.elements['product_id'].value;};data.quantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}",
          "id": "ec2e086a-cbaa-43b8-b1fa-25bd0fc65f73",
          "parameters": {
            "selectedVariable": "Custom JavaScript",
            "name": "CustomJsFunction",
            "type": "CustomJsFunction",
          ...
          "Variable": "CustomJsFunctionVariableec2e086acbaa43b8b1fa25bd0fc65f73"
        }
      ]
    },
  ...
  "blockTriggerIds": [],
  "fireTriggerIds": [
    "bb4d2de5-a6d2-4030-9e67-009feed51d0e"
  ],
  "fireLimit": "unlimited",
  "fireDelay": 0,
  "startDate": null,
  ...
  "blockedTriggerIds": []
          ...
          triggers: [
            ...
            {
  "id": "bb4d2de5-a6d2-4030-9e67-009feed51d0e",
  "type": "FormSubmit",
  "name": "FormSubmit",
  ...
  "Name": "tempname Trigger"
},
          ],
          variables: [
            
          { name: "CustomJsFunction", type: "CustomJsFunction", lookUpTable: [], defaultValue: "", parameters: { jsFunction: "function(){const data = {}; const formElement = document.querySelector('form#productform');if(formElement.elements['quantity']){if(formElement.elements['product_id']){data.id=formElement.elements['product_id'].value;};data.quantityKey=formElement.elements['quantity'].value;};return JSON.stringify(data)}" }, Variable: "CustomJsFunctionVariableec2e086acbaa43b8b1fa25bd0fc65f73" },
            {
